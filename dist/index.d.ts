...
interface FilterOptions {
    ...
    pluginFilters?: pluginFilters | pluginFilters2;
}
type PlayerEvents = {
    /**
...
declare class Player extends TypedEventEmitter<PlayerEvents> {
     ...
     */
    setEcho(echo: EchoSettings): Promise<void>;
    /**
...
export { type Address, AllowedPackets, type Band, type ChannelMixSettings, Connection, Connector, type ConnectorMethods, index as Connectors, Constants, type DistortionSettings, type EchoSettings, type EmptyResult, type ErrorResult, type Exception, type FilterOptions, type FreqSettings, type KaraokeSettings, type LavalinkPlayer, type LavalinkPlayerVoice, type LavalinkPlayerVoiceOptions, type LavalinkResponse, LoadType, type LowPassSettings, Node, type NodeCpu, type NodeEvents, type NodeFrameStats, type NodeInfo, type NodeInfoGit, type NodeInfoPlugin, type NodeInfoVersion, type NodeMemory, type NodeOption, type NonResumableHeaders, type PlayOptions, Player, type PlayerEvent, PlayerEventType, type PlayerEvents, type PlayerUpdate, type Playlist, type PlaylistResult, type Ready, Rest, RestError, type ResumableHeaders, type ResumeOptions, type RotationSettings, type RoutePlanner, type SearchResult, type ServerUpdate, type SessionInfo, type Severity, Shoukaku, type ShoukakuEvents, type ShoukakuOptions, type StateUpdatePartial, type Stats, type Structures, type TimescaleSettings, type Track, type TrackEndEvent, type TrackEndReason, type TrackExceptionEvent, type TrackResult, type TrackStartEvent, type TrackStuckEvent, type UpdatePlayerInfo, type UpdatePlayerOptions, type UpdatePlayerTrackOptions, Utils, type VoiceChannelOptions, type WebSocketClosedEvent, type pluginFilters, type pluginFilters2 };
